...
export const GUIAS = [
  {
    ...
    metaTitle: "Precio de Arriendo de Bodegas en San Bernardo 2026 | Guía por m²",
    metaDescription:
      "¿Cuánto cuesta arrendar una bodega industrial en San Bernardo? Valores de referencia por m², factores que mueven el precio y costos extra que debes considerar.",
    excerpt:
      "Valores de referencia por m², qué factores mueven el precio y los costos adicionales que nadie te cuenta — para pymes y grandes operaciones.",
    date: "2026-07-27",
    readMin: 6,
    ...
    faq: [
      {
        ...
        a: "Para superficies de 180 a 500 m² en San Bernardo, el arriendo mensual suele partir en torno a las 20–60 UF según equipamiento y plazo. Escríbenos por WhatsApp con la superficie que necesitas y te enviamos una cotización exacta el mismo día.",
      },
      {
      ...
      {
        q: "¿Por qué algunos avisos no publican precio?",
        a: "Porque el valor final depende de superficie, plazo, equipamiento y condición de entrega. Una cotización a medida evita precios inflados 'por si acaso'. Nosotros respondemos cotizaciones casi al instante por WhatsApp.",
      },
    ],
    blocks: [
      {
      ...
      {
        t: "p",
        x: "El arriendo de bodegas se expresa casi siempre en UF por m² al mes. Ese formato permite comparar proyectos de distinto tamaño: multiplicas el valor unitario por la superficie y obtienes el canon mensual. Por ejemplo, una bodega de 500 m² a 0,12 UF/m² son 60 UF mensuales.",
      },
      { t: "h2", x: "Valores de referencia en San Bernardo (2026)" },
      {
        t: "table",
        head: ["Tipo de espacio", "Rango referencial", "Perfil típico"],
        rows: [
          ["Bodega estándar (radier, cierre, seguridad)", "≈ 0,10 – 0,15 UF/m²/mes", "Pymes y bodegaje general"],
          ["Bodega equipada (trifásica, patio, altura)", "≈ 0,13 – 0,18 UF/m²/mes", "Distribución y manufactura liviana"],
          ["Grandes superficies (sobre 2.000 m²)", "Valor unitario negociable a la baja", "Centros de distribución y logística"],
          ["Built-to-suit (construcción a medida)", "Según proyecto y plazo", "Empresas medianas y grandes"],
        ],
      },
      {
        t: "note",
        x: "Estos rangos son referenciales del mercado de la Región Metropolitana y varían según equipamiento, plazo y condición de entrega. Para tu caso concreto, una cotización directa siempre será más precisa que cualquier tabla.",
      },
