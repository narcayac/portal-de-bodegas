...
export const GUIAS = [
  {
    ...
    date: "2026-07-27",
    readMin: 6,
    related: ["cuantos-metros-cuadrados-necesita-tu-bodega", "contrato-arriendo-bodega-industrial"],
    faq: [
      {
  ...
  },
  {
    ...
    date: "2026-07-27",
    readMin: 5,
    related: ["galpon-en-arriendo-san-bernardo", "precio-arriendo-bodega-san-bernardo"],
    faq: [
      {
