...
GUIAS.push({
  ...
  faq: [
    {
      ...
      a: "Según el reporte del tercer trimestre 2026 de Cushman & Wakefield, la vacancia total del mercado de bodegas de Santiago bajó a 3,83%, con la clase A operando en un mínimo histórico de solo 0,29%. Es una caída sostenida desde el peak cercano al 7% de 2025.",
    },
    {
  ...
  blocks: [
    {
      t: "p",
      x: "En Portal de Bodegas seguimos la evolución del mercado industrial de la Región Metropolitana para que empresas y propietarios decidan con información, no con intuición. Esta es la actualización de nuestro informe de mercado, con la fotografía a septiembre de 2026 a partir del reporte del tercer trimestre de Cushman & Wakefield y la prensa especializada del rubro.",
    },
    { t: "h2", x: "La vacancia toca mínimos históricos en clase A" },
    {
      t: "p",
      x: "La tendencia que veníamos reportando se profundizó: la vacancia total del mercado bajó a 3,83% en el tercer trimestre de 2026, y el segmento clase A —el más demandado— quedó en apenas 0,29%, un nivel que en la práctica significa que no hay superficie de primer nivel disponible para arrendar de inmediato.",
    },
    {
      t: "table",
      head: ["Período", "Vacancia", "Fuente"],
      rows: [
        ...
        ["Cierre 2025", "5,15% – 6,37%", "CBRE / Colliers (universos distintos)"],
        ["1er semestre 2026", "4,2% – 5,2%", "Cushman & Wakefield / CBRE"],
        ["3er trimestre 2026", "3,83% (0,29% clase A)", "Cushman & Wakefield"],
      ],
    },
    {
      t: "note",
    ...
    {
      t: "p",
      x: "El precio promedio pedido en Santiago se mantiene en 0,148 UF/m² al mes según el Marketbeat del tercer trimestre 2026 de Cushman & Wakefield, prácticamente sin variación respecto al trimestre anterior. La diferencia por calidad, eso sí, sigue firme.",
    },
    {
      t: "list",
      items: [
    ...
    {
      t: "p",
      x: "El dato más relevante del trimestre no es de precio ni de vacancia, sino de estrategia: de los 681.932 m² en construcción en la Región Metropolitana, un 61,5% (419.632 m²) ya tiene contrato de arriendo firmado antes de estar terminado. Según Rosario Meneses, Market Research Manager de Cushman & Wakefield, la menor velocidad de absorción está llevando a los inversionistas a priorizar proyectos respaldados por demanda concreta, reduciendo su exposición a desarrollos especulativos.",
    },
    {
      t: "note",
    ...
    {
      t: "note",
      x: "Fuentes: Cushman & Wakefield (Marketbeat Industrial Q3 2026, declaraciones de Rosario Meneses y Ariel Benzaquen) y prensa especializada del rubro. Elaboración: Portal de Bodegas, septiembre 2026. Actualizamos este informe periódicamente con cada nueva entrega de las consultoras.",
    },
    {
      t: "cta",
