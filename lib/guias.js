...
export const GUIAS = [
  {
    ...
    excerpt:
      "Nuestro valor de referencia (0,13 UF/m²), qué incluye, qué factores mueven el precio y los costos adicionales que nadie te cuenta — para pymes y grandes operaciones.",
    date: "2026-07-27",
    readMin: 6,
