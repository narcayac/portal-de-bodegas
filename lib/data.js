...
export const FAQ_CONTACTO = [
  {
    ...
    a: "Muy rápido: por WhatsApp te respondemos al instante en horario hábil. Por el formulario, el mismo día.",
  },
  {
...
export const WHY_US = [
  ...
  ["Respuesta rápida", "Escríbenos por WhatsApp y te respondemos al instante en horario hábil."],
