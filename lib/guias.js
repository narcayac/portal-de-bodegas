...
GUIAS.push({
  ...
  date: "2026-08-17",
  readMin: 6,
  related: ["mercado-bodegas-santiago-septiembre-2026", "precio-arriendo-bodega-san-bernardo", "bodegas-san-bernardo-hub-logistico"],
  faq: [
    {
...
GUIAS.push({
  slug: "construccion-a-medida-built-to-suit",
  eyebrow: "Built-to-suit",
  title: "Construcción a medida (built-to-suit): cómo funciona en San Bernardo",
  metaTitle: "Bodega Built-to-Suit en San Bernardo | Construcción a Medida",
  metaDescription:
    "¿Qué es el built-to-suit y cómo funciona? Diseña tu bodega industrial a medida en San Bernardo, ampliable hasta 30.000 m² en Bosque Catemito. Proceso y qué definir antes de partir.",
  excerpt:
    "Cuando ninguna bodega estándar te queda bien, se construye una que sí. Qué es el built-to-suit, cómo funciona el proceso y qué necesitas tener claro antes de partir.",
  date: "2026-09-02",
  readMin: 6,
  related: ["mercado-bodegas-santiago-septiembre-2026", "cuantos-metros-cuadrados-necesita-tu-bodega", "terreno-de-acopio-en-arriendo"],
  faq: [
    {
      q: "¿Qué es una bodega built-to-suit?",
      a: "Es una nave industrial diseñada y construida específicamente para tu operación, en vez de arrendar un espacio estándar y adaptarte tú a él. Se define la superficie, la altura útil, los accesos, las oficinas interiores y la distribución según cómo trabajas — no según lo que ya existe construido.",
    },
    {
      q: "¿Cuánto tiempo toma construir una bodega a medida?",
      a: "Depende del tamaño y la complejidad del proyecto — varía de semanas a varios meses. Lo primero es levantar contigo los requerimientos exactos (superficie, plazos, presupuesto) para poder darte un cronograma real, no una cifra genérica.",
    },
    {
      q: "¿Cuál es la superficie máxima que se puede construir?",
      a: "En Bosque Catemito, nuestro proyecto con más terreno disponible, se puede construir hasta 30.000 m² a medida. Para proyectos de esa escala, el built-to-suit deja de ser una opción y pasa a ser prácticamente la única forma de conseguir ese metraje en un solo recinto.",
    },
    {
      q: "¿Qué debo definir antes de empezar un proyecto built-to-suit?",
      a: "Como mínimo: superficie total y posibilidad de crecer por etapas, altura útil que necesita tu operación (racks, maquinaria, grúas), número y tipo de accesos para camiones, si necesitas oficinas u otros espacios interiores, y tu horizonte de plazo del contrato. Con eso ya se puede armar una propuesta concreta.",
    },
  ],
  blocks: [
    {
      t: "p",
      x: "Hay operaciones que no caben en una bodega estándar — porque necesitan más altura de la que ofrece el mercado, una combinación específica de oficinas y nave, accesos para un tipo de camión particular, o simplemente más metros de los que hay disponibles hoy en arriendo. Para esos casos existe el built-to-suit: construir la bodega a la medida exacta de la operación, en vez de forzar la operación a caber en un espacio que no fue pensado para ella.",
    },
    { t: "h2", x: "Qué es el built-to-suit" },
    {
      t: "p",
      x: "Built-to-suit (\"construido a medida\") es un modelo donde el propietario del terreno construye la nave industrial según las especificaciones del arrendatario, antes de que el contrato empiece a operar. La empresa define qué necesita — superficie, altura, accesos, oficinas, energía — y el proyecto se construye en función de eso, no al revés. Es distinto de arrendar una bodega ya construida y adaptarla con obras menores: acá el diseño parte desde cero pensando en tu operación.",
    },
    { t: "h2", x: "Cuándo conviene built-to-suit en vez de una bodega estándar" },
    {
      t: "list",
      items: [
        "Necesitas más superficie de la que hay disponible en arriendo hoy en la zona — proyectos grandes o centros de distribución de gran escala.",
        "Tu operación requiere una altura útil, un tipo de piso o una configuración de accesos que las bodegas estándar no ofrecen.",
        "Quieres crecer por etapas dentro de un mismo terreno, sin tener que mudarte cada vez que tu operación aumenta de tamaño.",
        "Necesitas una combinación específica de nave y oficinas, o instalaciones especiales según tu rubro.",
        "Tu horizonte de contrato es largo (varios años), lo que justifica invertir tiempo en un diseño a medida en vez de adaptarte a lo que ya existe.",
      ],
    },
    { t: "h2", x: "Cómo funciona el proceso, en términos generales" },
    {
      t: "list",
      items: [
        "Levantamiento de requerimientos — superficie, altura útil, accesos para camiones, oficinas, energía y cualquier instalación especial de tu operación.",
        "Propuesta de diseño y plazo — con esos requerimientos, se define la solución concreta: superficie final, distribución y un cronograma real de construcción.",
        "Definición de condiciones comerciales — canon de arriendo, plazo del contrato y condiciones de entrega, acordes al tamaño de la inversión que se está construyendo.",
        "Construcción — la nave se construye según lo acordado, con seguimiento del avance.",
        "Entrega e inicio de operación — recibes la bodega lista para operar, construida específicamente para tu forma de trabajar.",
      ],
    },
    { t: "h2", x: "Nuestra capacidad en Bosque Catemito" },
    {
      t: "p",
      x: "Bosque Catemito, en Camino Catemito 1990, San Bernardo, es nuestro proyecto con más terreno disponible: hoy tiene bodegas desde 360 m² combinables en módulos hasta 14.000 m², y el terreno permite construir hasta 30.000 m² a medida. Además cuenta con espacio para acopio a cielo abierto dentro del mismo recinto, por si tu operación combina superficie techada y descubierta. Está a minutos de la Ruta 5 Sur, con seguridad 24/7 y trato directo con el propietario, sin comisión de corretaje.",
    },
    {
      t: "note",
      x: "El built-to-suit no reemplaza a nuestros proyectos ya construidos — si tu necesidad cabe en una bodega estándar disponible hoy, esa sigue siendo la opción más rápida. El built-to-suit tiene sentido cuando el metraje, la altura o la configuración que necesitas simplemente no existen todavía.",
    },
    {
      t: "cta",
      x: "Cuéntanos qué necesita tu operación — superficie, altura, plazos — y vemos si conviene un proyecto a medida o si ya tenemos algo disponible que te sirve.",
      wa: "Hola, quiero información sobre construcción a medida (built-to-suit) en Bosque Catemito",
    },
  ],
});

GUIAS.push({
  slug: "mercado-bodegas-santiago-septiembre-2026",
  eyebrow: "Informe de mercado",
  title: "Mercado de bodegas en Santiago — Septiembre 2026: vacancia, precios y tendencias",
  metaTitle: "Mercado de Bodegas en Santiago — Septiembre 2026",
  metaDescription:
    "Vacancia en 3,83% (0,29% en clase A), precios en 0,148 UF/m²/mes y 61,5% de la construcción prearrendada: el mercado de bodegas en Santiago, con fuentes.",
  excerpt:
    "La vacancia toca mínimos históricos en clase A, los precios se mantienen estables y el mercado gira hacia contratos prearrendados en vez de construcción especulativa. Las cifras, con fuentes.",
  date: "2026-09-25",
  readMin: 6,
  related: ["mercado-bodegas-santiago-agosto-2026", "construccion-a-medida-built-to-suit"],
  faq: [
    {
      q: "¿Cuál es la vacancia de bodegas en Santiago en septiembre de 2026?",
      a: "Según el reporte del segundo trimestre 2026 (abril-junio) de Cushman & Wakefield, el más reciente disponible a septiembre, la vacancia total del mercado de bodegas de Santiago bajó a 3,83%, con la clase A operando en un mínimo histórico de solo 0,29%. Es una caída sostenida desde el peak cercano al 7% de 2025.",
    },
    {
      q: "¿Cuánto cuesta arrendar una bodega en Santiago en septiembre de 2026?",
      a: "El precio promedio pedido se mantiene en 0,148 UF/m² al mes, con 0,154 UF/m² en proyectos clase A y 0,148 UF/m² en clase B, según Cushman & Wakefield. En nuestros proyectos de San Bernardo el valor parte en 0,13 UF/m² con la bodega equipada.",
    },
    {
      q: "¿Es buen momento para arrendar una bodega?",
      a: "Con la clase A prácticamente sin disponibilidad (0,29% de vacancia), las superficies de mejor estándar se están arrendando casi al instante. Si tu operación necesita espacio pronto, cotizar con anticipación dejó de ser una recomendación genérica y pasó a ser necesario.",
    },
    {
      q: "¿Qué zona de Santiago conviene para una operación logística?",
      a: "Según Cushman & Wakefield, los submercados más buscados para clase A son el poniente/noroeste y el sur de Santiago — este último, además, es el preferido por el retail para abastecer la Región Metropolitana. San Bernardo mantiene su ventaja de conectividad con Ruta 5 Sur y Acceso Sur con valores más competitivos que los polos del norte.",
    },
    {
      q: "¿Qué es el aumento del built-to-suit en el mercado de bodegas?",
      a: "Es el cambio de estrategia que muestra el informe de septiembre: de los 681.932 m² en construcción en la Región Metropolitana, un 61,5% (419.632 m²) ya tiene contrato de arriendo firmado antes de terminarse. Los desarrolladores están priorizando construir a medida de un arrendatario confirmado en vez de construir de forma especulativa. Es exactamente el modelo que ofrecemos en Bosque Catemito.",
    },
  ],
  blocks: [
    {
      t: "p",
      x: "En Portal de Bodegas seguimos la evolución del mercado industrial de la Región Metropolitana para que empresas y propietarios decidan con información, no con intuición. Esta es la actualización de nuestro informe de mercado a septiembre de 2026, a partir del reporte del segundo trimestre de Cushman & Wakefield —el más reciente publicado, ya que el tercer trimestre cierra recién a fines de septiembre— y de la prensa especializada del rubro.",
    },
    { t: "h2", x: "La vacancia toca mínimos históricos en clase A" },
    {
      t: "p",
      x: "La tendencia que veníamos reportando se profundizó: la vacancia total del mercado bajó a 3,83% en el segundo trimestre de 2026, y el segmento clase A —el más demandado— quedó en apenas 0,29%, un nivel que en la práctica significa que no hay superficie de primer nivel disponible para arrendar de inmediato.",
    },
    {
      t: "table",
      head: ["Período", "Vacancia", "Fuente"],
      rows: [
        ...
        ["Cierre 2025", "5,15% – 6,37%", "CBRE / Colliers (universos distintos)"],
        ["1er semestre 2026", "4,2% – 5,2%", "Cushman & Wakefield / CBRE"],
        ["2º trimestre 2026", "3,83% (0,29% clase A)", "Cushman & Wakefield"],
      ],
    },
    {
      t: "note",
      x: "¿Por qué los rangos en los períodos anteriores? Cada consultora mide un universo distinto de propiedades (solo centros clase A/B, con o sin condominios menores), por eso sus cifras difieren entre sí. La tendencia, en todas, es la misma: la vacancia sigue bajando trimestre a trimestre.",
    },
    { t: "h2", x: "Precios: estables en el promedio, con la clase A defendiendo su valor" },
    {
      t: "p",
      x: "El precio promedio pedido en Santiago se mantiene en 0,148 UF/m² al mes según el Marketbeat del segundo trimestre 2026 de Cushman & Wakefield —un leve aumento respecto a las 0,147 UF/m² del primer trimestre—. La diferencia por calidad, eso sí, sigue firme.",
    },
    {
      t: "list",
      items: [
        "Bodegas clase B — en torno a 0,148 UF/m² pedido, muy cerca del promedio de mercado.",
        "Promedio de mercado — 0,148 UF/m²/mes pedido.",
        "Proyectos clase A — 0,154 UF/m²/mes, sostenidos por una disponibilidad casi nula.",
      ],
    },
    {
      t: "p",
      x: "Con una vacancia de clase A tan ajustada, cabría esperar presión al alza en los precios de ese segmento — algo que todavía no se refleja con fuerza en el promedio pedido, pero que vale la pena monitorear en los próximos reportes.",
    },
    { t: "h2", x: "El giro hacia el built-to-suit: menos especulación, más contratos firmados" },
    {
      t: "p",
      x: "El dato más relevante del trimestre no es de precio ni de vacancia, sino de estrategia: de los 681.932 m² en construcción en la Región Metropolitana, un 61,5% (419.632 m²) ya tiene contrato de arriendo firmado antes de estar terminado. El equipo de Market Research de Cushman & Wakefield —liderado por Rosario Meneses— atribuye esto a que la menor velocidad de absorción está llevando a los inversionistas a priorizar proyectos respaldados por demanda concreta, reduciendo su exposición a desarrollos especulativos.",
    },
    {
      t: "note",
      x: "Es, en la práctica, el modelo built-to-suit funcionando a escala de mercado: se construye para un arrendatario confirmado, no para ver quién llega. Profundizamos en cómo funciona este modelo —y en nuestra propia capacidad de hacerlo en Bosque Catemito— en nuestra guía de construcción a medida.",
    },
    { t: "h2", x: "El sur y el poniente concentran la demanda de clase A" },
    {
      t: "p",
      x: "Según Cushman & Wakefield, los submercados más buscados para bodegas clase A son el poniente/noroeste y el sur de Santiago. El sector sur, además, es el elegido por el segmento retail para abastecer la Región Metropolitana — una demanda que se suma a la industrial y logística que ya lo caracterizaba. San Bernardo sigue siendo un punto estratégico para operar hacia el sur o conectar con Ruta 5 Sur y Acceso Sur, con valores más competitivos que los polos del norte y la misma conectividad.",
    },
    { t: "h2", x: "Qué significa esto si estás buscando bodega" },
    {
      t: "list",
      items: [
        "Clase A casi sin disponibilidad. Si tu operación necesita estándar premium, cotiza ahora — la vacancia de 0,29% deja muy poco margen de espera.",
        "Los precios todavía no reflejan la presión de vacancia. Es un buen momento para cerrar plazos largos antes de que eso cambie.",
        "El built-to-suit ya no es una alternativa marginal. Si tu metraje o tu plazo lo justifican, construir a medida con contrato firmado de antemano es hoy la estrategia dominante del mercado, no la excepción.",
        "El sur combina demanda y valor. Sigue siendo uno de los submercados más buscados y, a la vez, más competitivo por m² que el norte.",
      ],
    },
    { t: "h2", x: "¿Y nuestros valores?" },
    {
      t: "p",
      x: "En Portal de Bodegas publicamos los precios — algo que en este mercado sigue siendo la excepción. Nuestras bodegas en San Bernardo parten en 0,13 UF/m² al mes, bajo el promedio pedido de mercado, con la bodega equipada y lista para operar y trato directo con el propietario, sin comisión de corretaje. Y si tu operación necesita algo que no existe hoy en el mercado —más metraje, más altura, una configuración distinta— en Bosque Catemito construimos a medida, con capacidad para hasta 30.000 m².",
    },
    {
      t: "note",
      x: "Fuentes: Cushman & Wakefield (Marketbeat Industrial Q2 2026, el más reciente disponible a septiembre) y prensa especializada del rubro. Elaboración: Portal de Bodegas, septiembre 2026. Actualizamos este informe periódicamente con cada nueva entrega de las consultoras.",
    },
    {
      t: "cta",
      x: "¿Buscas bodega en un mercado cada vez más ajustado? Cuéntanos superficie y uso, y te cotizamos hoy mismo.",
      wa: "Hola, quiero cotizar una bodega en San Bernardo",
    },
  ],
});
