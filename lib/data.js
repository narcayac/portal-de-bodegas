...
export const SITE = {
  ...
  email: "contacto@portaldebodegas.cl",
...
export const FAQ_GENERAL = [
  {
    q: "¿Qué tipos de empresas pueden arrendar con Portal de Bodegas?",
    a: "Empresas de cualquier rubro: logística, distribución, manufactura liviana, almacenaje y pymes en crecimiento.",
  },
  {
    q: "¿En qué comunas tienen proyectos disponibles?",
    a: "Hoy en San Bernardo, con cinco proyectos activos.",
  },
  {
    q: "¿El trato es directo o trabajan con corredores?",
    a: "Directo, sin intermediarios ni comisión de corretaje.",
  },
  {
    q: "¿Por qué no publican los precios?",
    a: "Cada cotización es a medida según metraje, plazo y proyecto. Escríbenos por WhatsApp para una propuesta.",
  },
];

export const FAQ_DISPONIBILIDAD = [
  {
    q: "¿Con qué frecuencia se actualiza la disponibilidad?",
    a: "Se revisa regularmente; si al contactarnos ya no está disponible, te ofrecemos alternativas.",
  },
  {
    q: "¿Puedo reservar un espacio antes de visitarlo?",
    a: "Escríbenos y coordinamos los pasos, incluyendo visita si es necesario.",
  },
];
...
// ── WHY US ──────────────────────────────────────────────────────────────────
export const WHY_US = [
  ["Trato directo", "Negocias con el propietario, sin corredores ni comisión de corretaje."],
  ["Respuesta rápida", "Te contactamos en menos de 24 horas hábiles con disponibilidad vigente."],
  ["Estándar industrial", "Seguridad 24/7, energía trifásica, radieres y acceso para camiones."],
  ["Cotización a medida", "Propuesta según metraje, plazo y proyecto, sin compromiso inicial."],
];
