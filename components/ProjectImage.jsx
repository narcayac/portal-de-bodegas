 ...
 */
export function ProjectImage({ projectId, height = 240, alt = "", status = "Disponible", showStatus = true }) {
  const [err, setErr] = useState(false);

  if (err || !projectId) {
    return <Img height={height} alt={alt} status={status} showStatus={showStatus} />;
  }
